    ...
    <div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
      <header class="mdl-layout__header mdl-layout__header--scroll mdl-color--primary">
        <div class="mdl-layout--large-screen-only">
          <a href="/">
          <img style="width:160px; padding:16px;user-drag: none;-moz-user-select: none;-webkit-user-drag: none;" class="logo-img" src="images/njit_acm_logo.png" alt="njit_acm_logo.png">
          </a>
        ...
        <div class="mdl-layout__tab-bar mdl-js-ripple-effect mdl-color--primary-dark">
          <a id="home-tab" href="#home" class="mdl-layout__tab is-active">Home</a>
          ...
          <a id="icpc-tab" href="#icpc" class="mdl-layout__tab">ICPC</a>
      ...
      <main class="mdl-layout__content">
        <div class="mdl-layout__tab-panel is-active" id="home">
          <section class="section--center mdl-grid mdl-grid--no-spacing">
            ...
            <div style="width: 600px;height:450px;margin-left:auto;margin-right:auto;background:url(images/chapter_image.png) no-repeat center" class="demo-card-image mdl-card mdl-shadow--2dp">
        ...
        <div class="mdl-layout__tab-panel" id="tutoring">
          ...
          <thead>
            <tr>
              <th class="mdl-data-table__cell--non-numeric">Tutor Name</th>
              <th class="mdl-data-table__cell--non-numeric">Classes/Subjects</th>
              <th class="mdl-data-table__cell--non-numeric">Days/Times Working</th>
              ...
              <div class="constitution">
                ...
                <div class="section__text mdl-cell mdl-cell--10-col-desktop mdl-cell--6-col-tablet mdl-cell--3-col-phone">
                  ...
                  <ul>
                    ...
                    <li>Section 2. An active member shall be defined as any member who has attended at least one-half of the scheduled meetings that have met up to that point in the semester.</li>
                ...
                <div class="section__text mdl-cell mdl-cell--10-col-desktop mdl-cell--6-col-tablet mdl-cell--3-col-phone">
                  ...
                  <ul>
                    <li>Section 1. The officers of this chapter shall be President, Vice-President, Secretary, Treasurer, Webmaster, and Public Relations.</li>
                    ...
                    <li>Section 4. All NJIT full-time undergraduate students who are active members of this chapter and whose grade point average for the preceding quarter is 2.5 or above shall be eligible for office, with the following restrictions:
                      <ul>
                        <li>A. Students who will graduate before the fall semester of the academic year following elections shall be ineligible for office. Their graduation date should be no less than three Spring and/or Fall semesters after the elections.</li>
                        <li>B. Presidential candidates must have been members of the ACM student chapter at NJIT for one full semester by the fall quarter in which they will serve.</li>
                      </ul>
                    </li>
                ...
                <div class="section__text mdl-cell mdl-cell--10-col-desktop mdl-cell--6-col-tablet mdl-cell--3-col-phone">
                  ...
                  <ul>
                    <li>Section 1. Proposed amendments to this constitution shall be distributed to all current officers and members.</li>
                    <li>Section 2. An amendment to this constitution shall be officially approved once unanimously agreed upon by all current officers, having received a favorable 2/3 vote from a quorum, and approved by the NJIT Student Senate.</li>
